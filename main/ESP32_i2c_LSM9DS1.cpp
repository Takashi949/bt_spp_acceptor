...
uint16_t LSM9DS1::begin(uint8_t agAddress, uint8_t mAddress, i2c_master_bus_handle_t bus_handle)
{
	...
	settings.bus_handle = bus_handle;

	i2c_device_config_t AGdev_cfg = {
		.dev_addr_length = I2C_ADDR_BIT_LEN_7,
		.device_address = agAddress,
		.scl_speed_hz = 400000,
	};
	ESP_ERROR_CHECK(i2c_master_bus_add_device(bus_handle, &AGdev_cfg, &settings.AGdev_handle));

	i2c_device_config_t Mdev_cfg = {
		.dev_addr_length = I2C_ADDR_BIT_LEN_7,
		.device_address = mAddress,
		.scl_speed_hz = 400000,
	};
	ESP_ERROR_CHECK(i2c_master_bus_add_device(bus_handle, &Mdev_cfg, &settings.Mdev_handle));
