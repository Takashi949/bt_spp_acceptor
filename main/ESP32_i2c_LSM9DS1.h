...
public:
	...
	uint16_t begin(uint8_t agAddress, uint8_t mAddress, i2c_master_bus_handle_t bus_handle); //By default use the default I2C addres, and use Wire port
